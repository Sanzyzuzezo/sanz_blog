    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-2 d-none d-md-block mt-1">My Post </h4>
      ...
      <div class="alert alert-success mt-3 col-lg-8 ml-3" role="alert">
          {{ session('success') }}
      </div>
      @endif
      <!-- partial -->
      <div class="table-responsive col-lg-8">
        <a href="posts/create" class="btn btn-info mb-3 mt-3">Create New Post</a>
          ...
          <tbody>
            @foreach ($posts as $post)
              <tr>
                ...
                <td>
                  <a href="/admin/posts/{{ $post->slug }}" class="badge bg-info"> <span class="mdi mdi-eye"></span></a>
                  <a href="/admin/posts/{{ $post->slug }}/edit" class="badge bg-warning"> <span class="mdi mdi-pencil"></span></a>
                  <form action="/admin/posts/{{ $post->slug }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
                    <button class="badge bg-danger border-0" onclick="return confirm('Apa kamu yakin ingin menghapus post ini?')">
